...
public  class Controlador <E> {
    ...
    public Telefono buscarTelf (int id){
       List <Telefono> listaT = (List <Telefono>)  List.copyOf(listado);
        ...
        return (Telefono) listaT.stream().filter(Telefono -> Telefono.getCodigo
        ()==id).findFirst().get();
    ...
    public Telefono buscarTelfUsu (String  cedula){
        ...
        return (Telefono) listaT.stream().filter(Telefono -> Telefono.getUsuario
        ().getCedula().equals(cedula)).findFirst().get();
    ...
    public Usuario buscarUsuarios (String cedula){
        ...
        return (Usuario) listaU.stream().filter(Usuario -> 
                Usuario.getCedula().equals(cedula)).findFirst().get();
